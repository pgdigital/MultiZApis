...
return [
    ...
    'description' => 'API de Whatsapp, autenticação feita pelo token do número',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                "/api/connection/update/{instanceId}",
                "/api/instances/connect/{instance}"
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'placeholder' => '{YOUR_TOKEN_NUMBER}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'O token do número.',
    ],
